...
export const DELIVERABLE_TEMPLATES = {
  ...
  // Handover Record - Biên bản bàn giao (Chi tiết theo chuẩn TT13/2020)
  handover: {
    name: 'Biên bản bàn giao sản phẩm phần mềm',
    sections: [
      '1. CĂN CỨ BÀN GIAO',
      '   1.1. Căn cứ pháp lý',
      '      - Hợp đồng số: _____ ngày _____',
      '      - Phụ lục hợp đồng số (nếu có): _____',
      '      - Biên bản nghiệm thu số: _____ ngày _____',
      '   1.2. Căn cứ kỹ thuật',
      '      - Tài liệu đặc tả yêu cầu phần mềm (SRS)',
      '      - Tài liệu thiết kế hệ thống (SDD)',
      '      - Kế hoạch triển khai đã được phê duyệt',
      '',
      '2. THÔNG TIN CÁC BÊN',
      '   2.1. BÊN GIAO (Bên B - Nhà phát triển)',
      '      - Tên công ty/đơn vị: _____',
      '      - Địa chỉ: _____',
      '      - Điện thoại: _____ | Email: _____',
      '      - Mã số thuế: _____',
      '      - Đại diện: _____ | Chức vụ: _____',
      '   2.2. BÊN NHẬN (Bên A - Khách hàng)',
      '      - Tên công ty/đơn vị: _____',
      '      - Địa chỉ: _____',
      '      - Điện thoại: _____ | Email: _____',
      '      - Mã số thuế: _____',
      '      - Đại diện: _____ | Chức vụ: _____',
      '',
      '3. THÔNG TIN SẢN PHẨM PHẦN MỀM',
      '   3.1. Thông tin chung',
      '      - Tên phần mềm: _____',
      '      - Phiên bản: _____',
      '      - Ngày phát hành: _____',
      '   3.2. Môi trường triển khai',
      '      - Loại hình: [On-premise / Cloud / Hybrid]',
      '      - Server/Infrastructure: _____',
      '      - Database: _____',
      '      - URL truy cập: _____',
      '   3.3. Các module/chức năng chính',
      '      | STT | Tên module | Mô tả | Trạng thái |',
      '      |-----|------------|-------|------------|',
      '      | 1   |            |       | Hoàn thành |',
      '',
      '4. NỘI DUNG BÀN GIAO',
      '   4.1. Phần mềm và hệ thống',
      '      | STT | Hạng mục | Mô tả | Số lượng | Ghi chú |',
      '      |-----|----------|-------|----------|---------|',
      '      | 1   | Phần mềm đã cài đặt | | 1 bộ | |',
      '      | 2   | Database production | | 1 | |',
      '      | 3   | Dữ liệu đã migrate | | | |',
      '   4.2. Mã nguồn (Source Code)',
      '      - Repository URL: _____',
      '      - Branch/Tag: _____',
      '      - Commit hash: _____',
      '      - Quyền truy cập đã cấp: [Admin / Developer / Read-only]',
      '      - Ngôn ngữ lập trình: _____',
      '      - Framework: _____',
      '   4.3. Tài liệu kỹ thuật',
      '      | STT | Tên tài liệu | Phiên bản | Định dạng | Số trang |',
      '      |-----|--------------|-----------|-----------|----------|',
      '      | 1   | Tài liệu đặc tả yêu cầu (SRS) | | .docx | |',
      '      | 2   | Tài liệu thiết kế (SDD) | | .docx | |',
      '      | 3   | Hướng dẫn cài đặt | | .docx | |',
      '      | 4   | Hướng dẫn sử dụng | | .docx | |',
      '      | 5   | Hướng dẫn quản trị | | .docx | |',
      '      | 6   | Tài liệu API | | .html | |',
      '   4.4. Licenses và Credentials',
      '      | STT | Loại | Mô tả | Thời hạn | Ghi chú |',
      '      |-----|------|-------|----------|---------|',
      '      | 1   | Software License | | | |',
      '      | 2   | Database License | | | |',
      '      | 3   | Third-party APIs | | | |',
      '   4.5. Tài khoản quản trị',
      '      | STT | Hệ thống | Username | Mô tả quyền | Đã đổi mật khẩu |',
      '      |-----|----------|----------|-------------|-----------------|',
      '      | 1   | Admin Portal | | Super Admin | [ ] Có [ ] Chưa |',
      '      | 2   | Database | | DBA | [ ] Có [ ] Chưa |',
      '      | 3   | Server | | SSH Access | [ ] Có [ ] Chưa |',
      '',
      '5. XÁC NHẬN ĐÀO TẠO',
      '   5.1. Đào tạo người dùng cuối',
      '      - Ngày đào tạo: _____',
      '      - Số buổi: _____ | Tổng thời gian: _____ giờ',
      '      - Số người tham gia: _____',
      '      - Nội dung đã đào tạo: _____',
      '   5.2. Đào tạo quản trị viên',
      '      - Ngày đào tạo: _____',
      '      - Số buổi: _____ | Tổng thời gian: _____ giờ',
      '      - Số người tham gia: _____',
      '      - Nội dung đã đào tạo: _____',
      '   5.3. Xác nhận của Bên nhận về đào tạo',
      '      [ ] Đã được đào tạo đầy đủ theo yêu cầu',
      '      [ ] Cần bổ sung đào tạo: _____',
      '',
      '6. ĐIỀU KIỆN BÀN GIAO',
      '   6.1. Điều kiện kỹ thuật',
      '      [ ] Phần mềm hoạt động ổn định trên môi trường production',
      '      [ ] Tất cả chức năng trong SRS đã được triển khai',
      '      [ ] Dữ liệu đã được migrate đầy đủ và chính xác',
      '      [ ] Backup system đã được thiết lập và test',
      '      [ ] Monitoring và alerting đã hoạt động',
      '   6.2. Điều kiện tài liệu',
      '      [ ] Tài liệu đầy đủ theo danh mục',
      '      [ ] Tài liệu đúng phiên bản phần mềm',
      '      [ ] Tài khoản và credentials đã được bàn giao an toàn',
      '   6.3. Các vấn đề tồn đọng (nếu có)',
      '      | STT | Vấn đề | Mức độ | Kế hoạch xử lý | Deadline |',
      '      |-----|--------|--------|----------------|----------|',
      '',
      '7. CAM KẾT BẢO HÀNH VÀ HỖ TRỢ',
      '   7.1. Thời gian bảo hành',
      '      - Bắt đầu: _____ | Kết thúc: _____',
      '      - Thời gian: _____ tháng',
      '   7.2. Phạm vi bảo hành',
      '      [ ] Sửa lỗi phần mềm (bugs)',
      '      [ ] Hỗ trợ kỹ thuật qua email/phone',
      '      [ ] Cập nhật bảo mật (security patches)',
      '      [ ] Không bao gồm: thay đổi yêu cầu, tính năng mới',
      '   7.3. Thông tin liên hệ hỗ trợ',
      '      - Hotline: _____',
      '      - Email: _____',
      '      - Thời gian hỗ trợ: _____',
      '      - SLA Response time: P1: ___ giờ | P2: ___ giờ | P3: ___ giờ',
      '',
      '8. TRÁCH NHIỆM CÁC BÊN SAU BÀN GIAO',
      '   8.1. Trách nhiệm Bên giao (Bên B)',
      '      - Hỗ trợ kỹ thuật trong thời gian bảo hành',
      '      - Sửa các lỗi phần mềm phát sinh',
      '      - Cập nhật tài liệu khi có thay đổi',
      '   8.2. Trách nhiệm Bên nhận (Bên A)',
      '      - Sử dụng phần mềm đúng mục đích',
      '      - Bảo mật thông tin tài khoản và hệ thống',
      '      - Thông báo kịp thời các sự cố phát sinh',
      '      - Backup dữ liệu định kỳ',
      '',
      '9. KẾT LUẬN VÀ XÁC NHẬN',
      '   9.1. Kết luận',
      '      Hai bên thống nhất xác nhận:',
      '      [ ] Bên giao đã bàn giao đầy đủ sản phẩm phần mềm và tài liệu theo danh mục',
      '      [ ] Bên nhận đã kiểm tra và tiếp nhận đầy đủ',
      '      [ ] Phần mềm đáp ứng các yêu cầu trong hợp đồng/SRS',
      '   9.2. Hiệu lực',
      '      Biên bản này có hiệu lực kể từ ngày ký và là căn cứ để:',
      '      - Thanh toán theo hợp đồng (nếu áp dụng)',
      '      - Bắt đầu thời gian bảo hành',
      '      - Chuyển giao trách nhiệm vận hành',
      '   9.3. Số bản',
      '      Biên bản được lập thành ___ bản có giá trị như nhau,',
      '      Bên A giữ ___ bản, Bên B giữ ___ bản.',
      '',
      '10. CHỮ KÝ XÁC NHẬN',
      '    ĐẠI DIỆN BÊN GIAO (BÊN B)          ĐẠI DIỆN BÊN NHẬN (BÊN A)',
      '    ',
      '    Họ tên: _____                      Họ tên: _____',
      '    Chức vụ: _____                     Chức vụ: _____',
      '    Ngày: _____                        Ngày: _____',
      '    ',
      '    (Ký tên, đóng dấu)                 (Ký tên, đóng dấu)',
      '',
      'PHỤ LỤC',
      '   - Phụ lục 1: Danh sách chi tiết tài liệu bàn giao',
      '   - Phụ lục 2: Danh sách điểm danh đào tạo',
      '   - Phụ lục 3: Checklist kiểm tra cài đặt',
      '   - Phụ lục 4: Danh sách vấn đề tồn đọng (nếu có)'
    ]
  },
